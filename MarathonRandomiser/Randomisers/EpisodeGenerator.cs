...
{
    internal class EpisodeGenerator
    {
        /// <summary>
...
#region DLC
        ...
        public static async Task MessageTableBuilder(string archivePath, string corePath, Dictionary<string, int> LevelOrder)
        {
        ...
        /// <param name="corePath">The platform path (ps3 or xenon)</param>
        /// <param name="LevelOrder">Used to determine what stage is where in order.</param>
        public static async Task ShopMessageTableBuilder(string archivePath, string corePath, Dictionary<string, int> LevelOrder)
        {
            // Load the shop MST.
