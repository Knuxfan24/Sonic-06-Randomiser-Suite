...
namespace Sonic06Randomiser
{
    static class Program
    {
        ...
        static public void RandomiseFunction(string filepath, string rndSeed, string output, bool randomEnemies, bool randomItems, bool randomCharacters, bool altCharacters, bool randomVoices, bool spoilerLog)
        {
